function createUnityInstance(t, n, d) {
    function l(e, t) {
        if (!l.aborted && n.showBanner) return "error" == t && (l.aborted = !0), n.showBanner(e, t);
        switch (t) {
            case "error":
                console.error(e);
                break;
    ...
    function u(e) {
        document.webkitCurrentFullScreenElement === t ? t.style.width && (s = t.style.width, c = t.style.height, t.style.width = "100%", t.style.height = "100%") : s && (t.style.width = s, t.style.height = c, c = s = "")
    }
    ...
    m.SystemInfo = function() {
        ...
        return d || console.warn("[UnityCache] Response is served without Content-Length header. Please reconfigure server to include valid Content-Length for better download performance."),
            function o() {
                return void 0 === e ? a.arrayBuffer().then(function(e) {
                    ...
                    if (e.done) {
                        if (h === l) return c;
                        if (h < l) return c.slice(0, h);
                        for (var t = new Uint8Array(h), n = (t.set(c, 0), f), r = 0; r < u.length; ++r) t.set(u[r], n), n += u[r].length;
                        return t
                    }
                    return h + e.value.length <= c.length ? (c.set(e.value, h), f = h + e.value.length) : u.push(e.value), h += e.value.length, i({
                        type: "progress",
                        response: a,
                        total: Math.max(l, h),
                        loaded: h,
        ...
        return a && (d.control = a.control, d.companyName = a.companyName, d.productName = a.productName, d.productVersion = a.productVersion), d.revalidated = !1, d.metaData = {
            ...
            }), C(n, a.onProgress, a.enableStreamingDownload)) : (e = s, (t = window.location.href.match(/^[a-z]+:\/\/[^\/]+/)) && !e.lastIndexOf(t[0], 0) || !n.headers.get("Last-Modified") && !n.headers.get("ETag") ? (e = (a = a || {}).headers || {}, a.headers = e, n.headers.get("Last-Modified") ? (e["If-Modified-Since"] = n.headers.get("Last-Modified"), e["Cache-Control"] = "no-cache") : n.headers.get("ETag") && (e["If-None-Match"] = n.headers.get("ETag"), e["Cache-Control"] = "no-cache"), l(o, a)) : fetch(s, {
                method: "HEAD"
            }).then(function(t) {
        ...
        m.preRun.push(function() {
            m.addRunDependency("dataUrl"), a.then(function(t) {
                ...
                for (n + s > t.length && o("Invalid binary data file header! (pos=" + n + ", headerSize=" + s + ", file length=" + t.length + ")"); n < s;) {
                    var d = r(),
                        l = r(),
                        c = (d + l > t.length && o("Invalid binary data file size! (offset=" + d + ", size=" + l + ", file length=" + t.length + ")"), r()),
                        u = (n + c > t.length && o("Invalid binary data file path name! (pos=" + n + ", length=" + c + ", file length=" + t.length + ")"), e.decode(t.subarray(n, n + c)));
                    n += c;
